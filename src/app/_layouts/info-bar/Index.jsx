                ...
                <div className="art-info-bar-frame">
                    ...
                    <div id="scrollbar2" className="art-scroll-frame">
                        ...
                        <div className="art-lang-skills p-30-15">
                            {(t('profile.skills.language') || []).map((item, key) => (
                        ...
                        <div className="art-hard-skills p-30-15">
                            ...
                            {(t('profile.skills.hard') || []).map((item, key) => (
                        ...
                        <ul className="art-knowledge-list p-15-0">
                            {(t('profile.skills.knowledge') || []).map((item, key) => (
                                <li key={`profile-skills-knowledge-item-${key}`}>{item}</li>
                            ))}
                        </ul>
                        {/* knowledge list end */}
                        ...
                        <div className="art-links-frame p-15-15">
                            {/* download cv button */}
                            <a href={AppData.profile.resume} className="art-link" download data-no-swup target="_blank">{t('common.cv')} <i className="fas fa-download"></i></a>
                        </div>
                        {/* links frame end */}
