                                        ...
                                        {Data.col1.items[key].button &&
                                            <>
                                                {Data.col1.items[key].button.type == 'image' ? (
                                                    ...
                                                    <a href={Data.col1.items[key].button.link} target="_blank" className="art-link art-color-link art-w-chevron" rel="noreferrer">{item.label}</a>
                                                )}
                                            </>
                                        }
                                    </div>
                                        ...
                                        {Data.col2.items[key].button &&
                                            <>
                                                {Data.col2.items[key].button.type == 'image' ? (
                                                    ...
                                                    <a href={Data.col2.items[key].button.link} target="_blank" className="art-link art-color-link art-w-chevron" rel="noreferrer">{item.label}</a>
                                                )}
                                            </>
                                        }
                                    </div>
